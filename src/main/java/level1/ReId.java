 ...
 * lording it over the poor minions who are stuck with more boring IDs. To quell the unrest, Commander Lambda
 * has tasked you with reassigning everyone new random IDs based on a Completely Foolproof Scheme.
 *
 ...
 * and the minion's new ID number will be the next five digits in the string. So if a minion draws "3", their
 ...
 * Lambda's string of all primes, and returns the next five digits in the string. Commander Lambda has a lot
 * of minions, so the value of n will always be between 0 and 10000.
 *
 * Languages
 * =========
 *
...
public class ReId {
    ...
    public static String solution(int i) {
        ...
        // Got this no through brute force debug runs. This number creates a string of length : 100006, which is
